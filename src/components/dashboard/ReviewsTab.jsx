    ...
    return (
        <Panel>
            <div className="border-b border-blue-100 bg-white px-6 py-5">
                ...
                <p className="mt-1 text-sm text-slate-500">Chỉ đánh giá approved mới hiển thị ngoài website.</p>
            </div>
                    ...
                    <tbody className="divide-y divide-blue-50">
                        {reviews.length === 0 ? (
                            ...
                            <tr key={review.id}>
                                ...
                                <td className="px-6 py-4"><span className={`rounded-full px-3 py-1 text-xs font-black ${statusClass[review.status]}`}>{review.status}</span></td>
